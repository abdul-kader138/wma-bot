...
class ActionReconciliationResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        ...
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('reason')->limit(80), Tables\Columns\TextColumn::make('status')->badge(), Tables\Columns\TextColumn::make('created_at')->dateTime()->sortable(),
