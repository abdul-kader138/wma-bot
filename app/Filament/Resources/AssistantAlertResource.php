...
class AssistantAlertResource extends MariaResource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('first_seen_at')->dateTime(config('app.display_datetime_format', 'd/m/Y H:i'))->sortable(),
            Tables\Columns\TextColumn::make('last_seen_at')->dateTime(config('app.display_datetime_format', 'd/m/Y H:i'))->sortable(),
