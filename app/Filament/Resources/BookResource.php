...
class BookResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        ...
        return $form->schema([
            ...
            Forms\Components\DateTimePicker::make('milestone_due_at'), Forms\Components\DatePicker::make('publication_target'),
            ...
            Forms\Components\Textarea::make('next_action')->columnSpanFull(), Forms\Components\DateTimePicker::make('next_action_at'),
        ])->columns(2);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('milestone_owner'), Tables\Columns\TextColumn::make('milestone_due_at')->dateTime()->sortable(),
