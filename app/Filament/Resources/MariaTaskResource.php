...
class MariaTaskResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\DateTimePicker::make('due_at')->displayFormat(config('app.display_datetime_format', 'd/m/Y H:i')),
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('due_at')->dateTime(config('app.display_datetime_format', 'd/m/Y H:i'))->sortable(),
