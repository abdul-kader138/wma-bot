...
class MeetingResource extends MariaResource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\DateTimePicker::make('starts_at')->displayFormat(config('app.display_datetime_format', 'd/m/Y H:i'))->disabled(),
            Forms\Components\DateTimePicker::make('ends_at')->displayFormat(config('app.display_datetime_format', 'd/m/Y H:i'))->disabled(),
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('starts_at')->dateTime(config('app.display_datetime_format', 'd/m/Y H:i'))->sortable(),
